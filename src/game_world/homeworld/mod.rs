...
impl Plugin for HomeWorldPlugin {
    fn build(&self, app: &mut bevy::app::App) {
        app.register_ldtk_int_cell_for_layer::<ColliderBundle>("CollisionGrid", 1)
            ...
            .add_system_set(SystemSet::on_enter(GameStage::Menu).with_system(ldtk::spawn_mapbundle))
            .add_system_set(
                SystemSet::on_enter(GameStage::Playing).with_system(ldtk::spawn_level_0),
            )

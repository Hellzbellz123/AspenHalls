...
use bevy::prelude::{debug, trace, NameOrEntity};
...
#[derive(Debug, Clone, Copy, Default, Eq, PartialEq, Hash, Resource, Reflect)]
#[reflect(Resource)]
...
pub fn log_event_debug<E: Debug + Clone + Reflect>(mut events: EventReader<pointer::PointerInput>) {
